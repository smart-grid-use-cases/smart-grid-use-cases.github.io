...
| --- | ---                    | ---                  |
| UC-DE-4| Area: Energy system </br> *Leave it blanc if not sure* | Energy Export in Discrete Packages |
...
UC4 covers the situation during times of energy surplus. The use case module predicts the energy generation for a 24h period and assigns export slots to the LEC. Outside of these slots the LEC reverts to island-mode.
