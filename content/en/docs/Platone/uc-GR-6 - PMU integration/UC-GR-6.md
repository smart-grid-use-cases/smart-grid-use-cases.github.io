...
**Short description**
The DSO operates the distribution network and handles the data sources coming from various systems such as SCADA/DMS, AMR, GIS etc. Data coming from various sources will be integrated into the Open DSO Technical Platform providing an adequate level of network observability. Low cost PMUs will be deployed in Mesogia area in critical network points and nodes where there is limited observability or a requirement to have an increased awareness such as DER and prosumers bidirectional power flows. PMUs will be integrated in the DSO Technical Platform following a data collection plan that will serve the functionalities of the flexibility tools and services. Measurements from PMUs will enhance network awareness in terms of data granularity and number of nodes observed in a cost effective manner. Also, the open DSO platform will perform the correlation of the data coming from different sources and systems during real time, providing to the DSO the technical capacity for flexibility mechanisms support and a friendly User Interface (UI) where the aforementioned will be visualised.
...
| --- | --- | --- | --- |
|I-01|Voltage and Current levels|||
|I-02|phasors|||
|I-03|Power Flows |||
|I-04|Consumption data|||
|I-05|Network topolgy change|||
