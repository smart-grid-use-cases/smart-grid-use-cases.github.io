...
|0.3|05 June 2020 |Natnael Kidane |Content |Draft|
...
| --- | --- |
| Scope | Innterconnect  distribution networks with bottom- up demand  of customers and local energy community <br/> Networks: <br/> markets|
| **Objective(s)** | - Enable local islanding and maximize consumption of locally produced energy in geographic proximity <br/> - Prerequisite for the advanced use cases 2 - 4 <br/> - Investigate ways to coordinate the interconnected distribution network with local energy communities|
...
| add text | Residential consumer| add text| add text|
| add text | Residential prostormer | add text| add text|
| add text | Commercial consumer| add text| add text|
| add text | Commercial prostormer | add text| add text|
| add text | Energy community | add text| add text|
| add text | Aggregator/Flexibility operator | add text| add text|
